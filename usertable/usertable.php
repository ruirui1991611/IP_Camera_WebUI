		...
		<form class="layui-form" id="add">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" id="input_name" name="name" class="layui-input" placeholder='<?php echo gettext("please input name"); ?>'>
				</div>
			</div>
		</form>
	</div>
	...
	layui.use(['layer', 'table'], function () {
		...
		table.render({
			...
			, cols: [[ //表头
				...
				, {fixed: 'right', title: '<?php echo gettext("operation"); ?>', width: 268, align: 'center', toolbar: '#barUser'}
			]]
