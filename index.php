...
<head>
	...
	<link rel="shortcut icon" href="xxx.icon" type="image/x-icon">
</head>
<body>
		...
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-left"  lay-filter="treenav">
				...
				<ul class="layui-nav layui-layout-right">
					...
					<li class="layui-nav-item">
						<a href="javascript:;"><img src="login/user.png" class="layui-nav-img"><?php echo $_SESSION['user']; ?></a>
							<dl class="layui-nav-child">
	...
	<iframe id="iframe" src="" name="iframe" frameborder="0" style="float:left;width:calc(100vw - 30px);height:calc(100vh - 30px);margin-left:15px;margin-top:15px"></iframe>
