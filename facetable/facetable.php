...
<script type="text/html" id="toolbarFace">
	...
	<button class="layui-btn layui-btn-sm" lay-event="camera_face_capture"><?php echo gettext("face capture"); ?></button>
	<button class="layui-btn layui-btn-sm" lay-event="upload" id="up_img"><?php echo gettext("face capture from image"); ?></button>
	<button class="layui-btn layui-btn-sm" lay-event="upload" id="up"><?php echo gettext("customized database"); ?></button>
	<button class="layui-btn layui-btn-sm" lay-event="download" id="dl_db"><a href="../download/save_database.php" style="color:white;"><?php echo gettext("save database"); ?></a></button>
	<button class="layui-btn layui-btn-sm" lay-event="download" id="dl_img"><a href="../download/save_capture_image.php" style="color:white;"><?php echo gettext("capture and save image"); ?></a></button>
	</div>
</script>
<script type="text/html" id="barFace">
	<a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail" style="display:none"><?php echo gettext("check"); ?></a>
		...
		<form class="layui-form" id="modify">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" id="input_index" name="index" class="layui-input" placeholder="0" readonly="true">
				</div>
			</div>
			<div class="layui-form-item">
	...
	layui.use(['layer', 'table'], function () {
		...
		table.render({
			...
			, cols: [[ //表头
				...
				, {fixed: 'right', title: '<?php echo gettext("operation"); ?>', width: 168, align: 'center', toolbar: '#barFace'}
			]]
		...
		table.on('tool(facetable)', function (obj) {
			...
			if (obj.event === 'detail') {
				...
				layer.confirm(
					...
					,{title:'<?php echo gettext("Message"); ?>', btn:['<?php echo gettext("OK"); ?>', '<?php echo gettext("Cancel"); ?>']}
					,function (index) {
						obj.del();
						layer.close(index);
						delete_row(data);
